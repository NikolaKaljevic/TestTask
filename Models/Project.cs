...
namespace Task_Tracker.Models;
    ...
    public class Project
    {
        ...
        public static List<Task> Task_list { get; set; } = new List<Task>(){ new Task (1,"vsvsv" ,"vnvaoivd", Status.To_Do, Task_Priority.High), new Task(1, "bghf", "vnvghfkaaoivd", Status.To_Do, Task_Priority.High)};
